...
if [ "$color_prompt" = yes ]; then
	...
	# PS1="${debian_chroot:+($debian_chroot)}\[\033[00;32m\]\u@\h\[\033[00m\]:\[\033[00;34m\]\w \[\e[91m\]\$(parse_git_branch)\[\033[00m\]\$ "
else
...
__conda_setup="$('/home/foti/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
